...
const BannerService = ({ image, serviceName, defaultImage, bookingImage, isBooking }) => {
  ...
  return (
    ...
    {/* Thay đổi chiều cao cho banner ở các kích thước màn hình khác nhau */}
    <div className="min-h-[500px] sm:min-h-[600px] lg:min-h-[700px] relative z-0 h-full max-w-6xl mx-auto flex flex-col justify-center items-center text-center text-white p-4 sm:p-6">
      {/* Nội dung khác có thể được thêm ở đây */}
    </div>
    <div className="absolute bottom-12 left-[450px] transform -translate-x-1/2 z-50 text-white">
