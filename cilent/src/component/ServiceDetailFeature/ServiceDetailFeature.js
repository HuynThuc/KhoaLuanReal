  ...
  return (
    <section className="bg-white">
      <div className="container mx-auto">
        <div className="container mx-auto py-8 px-4 lg:px-60 bg-white text-black">
        ...
        <div className="text-center mb-12 text-black">
          <h3 className="text-3xl font-semibold pb-3">Lợi ích khóa học</h3>
        ...
        {/* Các mục với icon */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4"> {/* Sử dụng grid responsive */}

          {/* Mục 1 */}
          <div className="flex flex-col items-center text-center">
            <div className="icon mb-4">
              <img src={muscleicon} alt="Muscle icon" className="w-24 h-24 sm:w-32 sm:h-32" /> {/* Responsive icon size */}
            </div>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="icon mb-4">
              <img src={kneecap} alt="Kneecap icon" className="w-24 h-24 sm:w-32 sm:h-32" /> {/* Responsive icon size */}
            </div>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="icon mb-4">
              <img src={muscleicon1} alt="Muscle icon 1" className="w-24 h-24 sm:w-32 sm:h-32" /> {/* Responsive icon size */}
            </div>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="icon mb-4">
              <img src={heart} alt="Heart icon" className="w-24 h-24 sm:w-32 sm:h-32" /> {/* Responsive icon size */}
            </div>
